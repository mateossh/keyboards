...
/* TODO
 * - fix comments
 * - find a way to add F11 and F12 on ESC_MOD layer
 */
...
#define LT_SWAP MAGIC_SWAP_LALT_LGUI
#define LT_UNSWAP MAGIC_UNSWAP_LALT_LGUI
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, BACKLIT, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_RALT, ESC_MOD, ESC_MOD, KC_RCTL
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  LT_SWAP, LT_UNSWAP, QWERTY,  COLEMAK,  _______, _______, _______,
...
[_UTILS] = LAYOUT_planck_grid(
    ...
    _______, KC_VOLD, KC_MUTE, KC_VOLU, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
)
